...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en" suppressHydrationWarning>
      ...
      <body className="relative flex flex-col  bg-center bg-cover bg-[url('/bg-img.jpg')] ">
            ...
            <header className="w-full flex justify-between  px-4 py-8 overflow-hidden">
              <Link href="/">
                <svg width="135" height="47" viewBox="0 0 135 47" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  />
                  <path d="M32.2838 1.95834L28.1296 6.1126" stroke="#FF00A8" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                  <path d="M15.6666 1.95834L19.8209 6.1126" stroke="#FF00A8" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                  <path
